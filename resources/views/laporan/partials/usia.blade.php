...
<table class="table table-hover">
	<tr>
		<th>Usia</th>
		<th style="background-color:skyblue;">Jumlah Kasus</th>
	...
	<tr>
		...
		<td style="background-color:skyblue;">{{ count($usia["anakKecil"]) }}</td>
		@foreach($typeCases as $key => $value)
	...
	<tr>
		...
		<td style="background-color:skyblue;">{{ count($usia["remaja12sd15"]) }}</td>
		@foreach($typeCases as $key => $value)
	...
	<tr>
		...
		<td style="background-color:skyblue;">{{ count($usia["remaja16sd17"]) }}</td>
		@foreach($typeCases as $key => $value)
	...
	<tr>
		...
		<td style="background-color:skyblue;">{{ count($usia["dewasa"]) }}</td>
		@foreach($typeCases as $key => $value)
