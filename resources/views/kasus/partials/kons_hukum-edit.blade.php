    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          {!! Form::text('tanggal', null, array('class' => 'form-control date-picker', 'id' => 'tanggal_kons_hukum', 'autocomplete' => 'off')) !!}
        </div>
        <div class="form-group">
          {!! Form::label('keterangan', 'Keterangan', array('class' => 'strongLabel')) !!}
          <textarea name="keterangan" class="form-control" placeholder="Keterangan" rows="3" autocomplete="off">{{$konsHukumActive->keterangan}}</textarea>
        </div>
      </div>
