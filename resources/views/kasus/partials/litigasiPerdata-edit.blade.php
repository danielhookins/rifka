<?php $litigasiPerdataActive = Session::get('litigasiPerdata-active') ?>

<div class="modal fade" id="litigasiPerdata-edit">
  <div class="modal-dialog">
    <div class="modal-content">

      {!! Form::model($litigasiPerdataActive, array(
        'route' => array('kasus.litigasiPerdata.update', 
          $litigasiPerdataActive->kasus_id, 
          $litigasiPerdataActive->litigasi_perdata_id), 
        'class'=>'form', 
        'method' => 'PUT')) 
      !!}
