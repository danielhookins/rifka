    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          {!! Form::text('tanggal', null, array('class' => 'form-control date-picker', 'id' => 'tanggal_medis', 'autocomplete' => 'off')) !!}
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <textarea name="keterangan" class="form-control" placeholder="Keterangan" rows="3" autocomplete="off">{{$medisActive->keterangan}}</textarea>
        </div>
      </div>
